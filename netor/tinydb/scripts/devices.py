...
class Devices(dbparam.DbParam):
    ...
    def list(self):
        ...
        if q == "1":
            ...
            string = input("Enter device IP, name, or OS " + str(self._OS_LIST) + ": ")
        ...
        if not res:
            ...
            if not res:
                ...
                if self.table_devices.search(query_site & query_customer & (Query().dev_name == dev_name)):
                    ...
                    return False
                os_input = input("Operating System " + str(self._OS_LIST) + ": ")
                if os_input not in self._OS_LIST:
                    print("\nOS not in list")
                    return False
    ...
    def modify(self):
        ...
        if not res:
            ...
            if not res:
                ...
                if new_os not in self._OS_LIST:
                    print("\nOS not in list")
                    return False
