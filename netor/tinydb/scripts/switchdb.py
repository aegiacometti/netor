...
def switchdb():
    ...
    if db_name == '':
        ...
        print("\nCreating new DB")
        db_name = NETOR_HOME_DIRECTORY + "netor/tinydb/data/" + db_name + ".json"
...
def update_config(full_db_path_name):
    """
    ...
    *To complete the process you need to push the DB with netor-db-push*.
    ...
    netorconf.replace_static_vars_scripts((NETOR_HOME_DIRECTORY + "netor/tinydb/scripts/listdb.py"),
                                          "DB_PATH_NAME = ", full_db_path_name)
    netorconf.replace_static_vars_scripts((NETOR_HOME_DIRECTORY + "netor/tinydb/scripts/pushcustdb.py"),
                                          "DB_PATH_NAME = ", full_db_path_name)
    netorconf.replace_static_vars_scripts((NETOR_HOME_DIRECTORY + "netor/tinydb/scripts/worker.py"),
                                          "DB_PATH_NAME = ", full_db_path_name)
    netorconf.replace_static_vars_scripts((NETOR_HOME_DIRECTORY + "netor/tinydb/scripts/importcsv.py"),
                                          "DB_PATH_NAME = ", full_db_path_name)
